...
namespace Nop.Plugin.Api
{
    public class ApiPlugin : BasePlugin, IAdminMenuPlugin
    {
        ...
        public void ManageSiteMap(SiteMapNode rootNode)
        {
            ...
            string settingsMenuName = _localizationService.GetResource("Plugins.Api.Admin.Menu.Settings.Title", languageId: _workContext.WorkingLanguage.Id, defaultValue: "Settings");

            string manageClientsMenuName = _localizationService.GetResource("Plugins.Api.Admin.Menu.Clients.Title", languageId: _workContext.WorkingLanguage.Id, defaultValue: "Clients");
