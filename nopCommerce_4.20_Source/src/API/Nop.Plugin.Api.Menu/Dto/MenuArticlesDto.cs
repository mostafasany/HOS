...
namespace Nop.Plugin.Api.Menu.Dto
{
    ...
    public class MenuArticlesDto : BaseDto
    {
        ...
        [JsonProperty("MenuItemsSecondRow")] public List<ArticlesDto> ArticlesSecondRow { get; set; }

        [JsonProperty("MenuItemsThirdRow")] public List<ArticlesDto> ArticlesThirdRow { get; set; }
    }
}