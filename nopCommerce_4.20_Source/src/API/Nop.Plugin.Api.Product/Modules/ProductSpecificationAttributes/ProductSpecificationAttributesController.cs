...
using Nop.Plugin.Api.Product.Modules.ProductSpecificationAttributes.Model;
using Nop.Plugin.Api.Product.Modules.ProductSpecificationAttributes.Translator;
using Nop.Plugin.Api.Product.Modules.SpecificationAttributes.Dto;
...
namespace Nop.Plugin.Api.Product.Modules.ProductSpecificationAttributes
{
    public class ProductSpecificationAttributesController : BaseApiController
    {
        ...
        public IActionResult CreateProductSpecificationAttribute(
            ...
            Delta<ProductSpecificationAttributeDto> productSpecificaitonAttributeDelta)
        {
            ...
            CustomerActivityService.InsertActivity("AddNewProductSpecificationAttribute",
                productSpecificationAttribute.Id.ToString());

            // Preparing the result dto of the new product
            var productSpecificationAttributeDto =
                _dtoHelper.PrepareProductSpecificationAttributeDto(productSpecificationAttribute);

            var productSpecificationAttributesRootObjectDto = new ProductSpecificationAttributesRootObjectDto();
            productSpecificationAttributesRootObjectDto.ProductSpecificationAttributes.Add(
        ...
        public IActionResult DeleteProductSpecificationAttribute(int id)
        {
            ...
            //activity log
            CustomerActivityService.InsertActivity("DeleteProductSpecificationAttribute",
                LocalizationService.GetResource("ActivityLog.DeleteProductSpecificationAttribute"),
        ...
        public IActionResult GetProductSpecificationAttributeById(int id, string fields = "")
        {
            ...
            productSpecificationAttributesRootObject.ProductSpecificationAttributes.Add(
                productSpecificationAttributeDto);
        ...
        public IActionResult GetProductSpecificationAttributes(ProductSpecifcationAttributesParametersModel parameters)
        {
            ...
            var productSpecificationAttribtues = _specificationAttributeApiService.GetProductSpecificationAttributes(
                parameters.ProductId, parameters.SpecificationAttributeOptionId, parameters.AllowFiltering,
                parameters.ShowOnProductPage, parameters.Limit, parameters.Page, parameters.SinceId);

            var productSpecificationAttributeDtos = productSpecificationAttribtues
                .Select(x => _dtoHelper.PrepareProductSpecificationAttributeDto(x)).ToList();
        ...
        [ProducesResponseType(typeof(ErrorsRootObject), (int)HttpStatusCode.BadRequest)]
        [GetRequestsErrorInterceptorActionFilter]
        public IActionResult GetProductSpecificationAttributesCount(
            ProductSpecifcationAttributesCountParametersModel parameters)
        {
            var productSpecificationAttributesCount =
                _specificationAttributeService.GetProductSpecificationAttributeCount(parameters.ProductId,
                    parameters.SpecificationAttributeOptionId);
            ...
            Delta<ProductSpecificationAttributeDto> productSpecificationAttributeDelta)
        {
            ...
            var productSpecificationAttribute =
                _specificationAttributeService.GetProductSpecificationAttributeById(productSpecificationAttributeId);
            if (productSpecificationAttribute == null)
                return Error(HttpStatusCode.NotFound, "product specification attribute", "not found");
            ...
            CustomerActivityService.InsertActivity("EditProductSpecificationAttribute",
                productSpecificationAttribute.Id.ToString());
            ...
            productSpecificatoinAttributesRootObjectDto.ProductSpecificationAttributes.Add(
                productSpecificationAttributeDto);
