...
namespace Nop.Plugin.Api.Product.Modules.SpecificationAttributes.Service
{
    public class SpecificationAttributesApiService : ISpecificationAttributeApiService
    {
        ...
        public IList<ProductSpecificationAttribute> GetProductSpecificationAttributes(int? productId = null,
        ...
        public IList<SpecificationAttribute> GetSpecificationAttributes(int limit = Configurations.DefaultLimit,
