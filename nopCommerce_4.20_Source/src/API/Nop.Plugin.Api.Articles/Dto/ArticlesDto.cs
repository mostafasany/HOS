...
namespace Nop.Plugin.Api.Article.Dto
{
    ...
    public class ArticlesDto : BaseDto
    {
        ...
        [JsonProperty("allowComments")] public bool AllowComments { get; set; }

        [JsonProperty("commentCount")] public int CommentCount { get; set; }

        [JsonProperty("createdOnUtc")] public DateTime CreatedOnUtc { get; set; }

        [JsonProperty("updatedOnUtc")] public DateTime UpdatedOnUtc { get; set; }
