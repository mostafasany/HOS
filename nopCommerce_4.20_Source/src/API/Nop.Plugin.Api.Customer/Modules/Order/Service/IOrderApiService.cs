...
namespace Nop.Plugin.Api.Customer.Modules.Order.Service
{
    public interface IOrderApiService
    {
        ...
        IList<Core.Domain.Orders.Order> GetOrders(IList<int> ids = null, DateTime? createdAtMin = null,
        ...
        IList<Core.Domain.Orders.Order> GetOrdersByCustomerId(IList<int> ids = null, DateTime? createdAtMin = null,
            DateTime? createdAtMax = null,
            int limit = Configurations.DefaultLimit, int page = Configurations.DefaultPageValue,
