...
namespace Nop.Plugin.Api.Customer.Modules.Order.Service
{
    public class OrderApiService : IOrderApiService
    {
        ...
        public OrderApiService(IRepository<Core.Domain.Orders.Order> orderRepository)
        {
            _orderRepository = orderRepository;
        }

        public IList<Core.Domain.Orders.Order> GetOrdersByCustomerId(IList<int> ids = null,
            ...
            OrderStatus? status = null, PaymentStatus? paymentStatus = null, ShippingStatus? shippingStatus = null,
            int? customerId = null,
            int? storeId = null)
        {
            var query = GetOrdersQuery(createdAtMin, createdAtMax, status, paymentStatus, shippingStatus, ids,
                customerId, storeId);
        ...
        public IList<Core.Domain.Orders.Order> GetOrders(IList<int> ids = null, DateTime? createdAtMin = null,
        ...
        {
            return orderId <= 0 ? null : _orderRepository.Table.FirstOrDefault(order => order.Id == orderId && !order.Deleted);
        }

        public int GetOrdersCount(DateTime? createdAtMin = null, DateTime? createdAtMax = null,
            OrderStatus? status = null,
            PaymentStatus? paymentStatus = null, ShippingStatus? shippingStatus = null,
            int? customerId = null, int? storeId = null)
        {
            var query = GetOrdersQuery(createdAtMin, createdAtMax, status, paymentStatus, shippingStatus,
                customerId: customerId, storeId: storeId);

            return query.Count();
        }

        private IQueryable<Core.Domain.Orders.Order> GetOrdersQuery(DateTime? createdAtMin = null,
            DateTime? createdAtMax = null, OrderStatus? status = null,
