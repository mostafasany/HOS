...
namespace Nop.Plugin.Api.Customer.Modules.NewsLetterSubscription.Service
{
    public class NewsLetterSubscriptionApiService : INewsLetterSubscriptionApiService
    {
        ...
        public NewsLetterSubscriptionApiService(
            IRepository<Core.Domain.Messages.NewsLetterSubscription> newsLetterSubscriptionRepository,
        ...
        public List<Core.Domain.Messages.NewsLetterSubscription> GetNewsLetterSubscriptions(
        ...
        private IQueryable<Core.Domain.Messages.NewsLetterSubscription> GetNewsLetterSubscriptionsQuery(
            DateTime? createdAtMin = null, DateTime? createdAtMax = null, bool? onlyActive = true)
        {
            var query = _newsLetterSubscriptionRepository.Table.Where(nls =>
                nls.StoreId == _storeContext.CurrentStore.Id);
