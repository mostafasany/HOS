...
namespace Nop.Plugin.Api.Modules.Manufacturer
{
    ...
    public class ManufacturersController : BaseApiController
    {
        ...
        public IActionResult GetManufacturerById(int id, string fields = "")
        {
            ...
            Core.Domain.Catalog.Manufacturer manufacturer = _manufacturerApiService.GetManufacturerById(id);
        ...
        [ProducesResponseType(typeof(ErrorsRootObject), (int) HttpStatusCode.BadRequest)]
        [GetRequestsErrorInterceptorActionFilter]
        public IActionResult GetManufacturers(CategoriesParametersModel parameters)
        {
            ...
            IEnumerable<Core.Domain.Catalog.Manufacturer> allManufacturers = _manufacturerApiService.GetManufacturers(parameters.Ids, parameters.Limit, parameters.Page, parameters.SinceId,
        ...
        [ProducesResponseType(typeof(ErrorsRootObject), (int) HttpStatusCode.BadRequest)]
        [GetRequestsErrorInterceptorActionFilter]
        public IActionResult GetManufacturersCount(CategoriesCountParametersModel parameters)
        {
            int allmanufacturersCount = _manufacturerApiService.GetManufacturersCount(parameters.PublishedStatus);

            var manufacturersRootObject = new CategoriesCountRootObject
            {
